...
import com.example.portofolioapp.RVAndroidAdapter
...
private const val PORTOFOLIO_LINK = "https://www.haydarahmad.my.id/"
...
private val binding:FragmentAndroidBinding get() = _binding!!
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        androidAdapter.onItemCliked = { seletedData : Portofolio ->
            CustomTabsIntent.Builder().build()
                .launchUrl(requireContext(), Uri.parse(seletedData.link))
        }
